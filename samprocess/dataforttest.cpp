...
void DataForTTest(int argc, char* argv[]){
    if (argc != 6){
    	cout << "Error! Invalid Parameter Number in DataForTTest()!" << endl;
	return;
    }
    ...
    string strSamplingStep = string(argv[5]);
    ...
    string outputFileName = prefix + "-data-ttest.txt";
